...
function newRoute(){
    ...
    for (i = 0; i < polylineCoordinates.length; i++) {  
      marker = new google.maps.Marker({
		...
		icon: "http://m.geostations.com/img/steamtrain.png",
        map: map
      });
	  markers.push(marker);	  	  
	        google.maps.event.addListener(marker, 'click', (function(marker, i) {
        return function() {
          infowindow.setContent("<div id=\""+polylineAbbr[i]+"\" class=\"infowindow\"><img id=\"loader\" src=\"http://m.geostations.com/img/ajax-loader-infowindow.gif\"></div>");
